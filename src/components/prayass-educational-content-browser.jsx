...
export default function Index() {
  ...
  const getSubjectColor = (subjectName) => {
    const colors = {
      ...
      "Physical chemistry": "bg-purple-500",
      "Organic Chemistry": "bg-orange-500",
      Mathematics: "bg-blue-500",
      "Inorganic Chemistry": "bg-gray-500",
    };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {subjects.map((subject, index) => (
              <div
                ...
                className="bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow cursor-pointer p-8 text-center"
              >
                <div
                  className={`w-16 h-16 ${getSubjectColor(subject.name)} rounded-full mx-auto mb-4`}
                ></div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <div className="flex items-center text-sm text-gray-500 mb-4">
              <span className="text-blue-600">PRAYASS</span>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <div className="flex items-center text-sm text-gray-500 mb-4">
              ...
              <span className="text-blue-600">{currentSubject?.name}</span>
              <i className="fas fa-chevron-right mx-2"></i>
              <span className="text-blue-600">{currentChapter?.name}</span>
            </div>
            <h1 className="text-3xl font-bold text-gray-800 mb-4 font-inter">
              {currentChapter?.name}
            </h1>
